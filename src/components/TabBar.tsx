...
const TABS: { key: TabKey; label: string; route: string; badge?: number }[] = [
  { key: 'map', label: 'מפה', route: '/map' },
  { key: 'circles', label: 'המעגלים שלי', route: '/my-circles' },
  { key: 'notifications', label: 'התראות', route: '/notifications', badge: 2 },
              ...
              <View>
                ...
                {t.badge ? (
                  <View style={styles.badge}>
                    <Txt style={{ color: '#fff', fontSize: 9.5, fontFamily: fonts.extrabold }}>{t.badge}</Txt>
                  </View>
                ) : null}
              </View>
              <Txt
